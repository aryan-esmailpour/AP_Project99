...
class guim:
    ...
    def make_buttons(self):
        ...
        self.resume_button = tkr.Button(self.wind, width = 5, height = 1, text = "GO", command = actions.resume_music)
    ...
    def set_volume(self):
        self.VolumeLevel = tkr.Scale(self.wind, from_ = 100, to_ = 0, orient = tkr.VERTICAL, command = self.update_vlc, resolution = 1)
